...
def bubble_sort_helper(collection: list[Any]) -> list[Any]:
    """Helper function that performs a single pass of Bubble Sort."""
    swapped = False
...
def bubble_sort_iterative(collection: list[Any]) -> list[Any]:
    """Iterative Bubble Sort using the helper function."""
    length = len(collection)
    for _ in range(length):
        if not bubble_sort_helper(collection):
            break
    return collection

def bubble_sort_recursive(collection: list[Any]) -> list[Any]:
    """Recursive Bubble Sort using the helper function."""
    if not bubble_sort_helper(collection):
        return collection
